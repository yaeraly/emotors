...
import { applyMarkup, deriveMarkupPercent, validateProductPrices } from '@/lib/pricing-table-utils';
...
export default function PricingProductsPage() {
  ...
  function onPriceChange(
    ...
    updateRow(productId, (row) => withMarkupsFromPrices({ ...row, [field]: value }));
  }
        ...
        <table className="w-full min-w-[980px] table-fixed divide-y divide-slate-200 text-xs">
          <thead className="bg-slate-50 text-left font-bold uppercase tracking-wide text-slate-500">
            <tr>
              ...
              <th className="w-[7%] px-1 py-2">{t('pricing.colWholesaleMarkup')}</th>
              <th className="w-[8%] px-1 py-2">{t('pricing.colWholesalePrice')}</th>
              <th className="w-[7%] px-1 py-2">{t('pricing.colHqWholesaleMarkup')}</th>
              <th className="w-[8%] px-1 py-2">{t('pricing.colHqWholesalePrice')}</th>
              <th className="w-[7%] px-1 py-2">{t('pricing.colRetailMarkup')}</th>
              <th className="w-[8%] px-1 py-2">{t('pricing.colRetailPrice')}</th>
              <th className="w-[7%] px-1 py-2">{t('pricing.colMinimumMarkup')}</th>
              <th className="w-[8%] px-1 py-2">{t('pricing.colMinimumPrice')}</th>
