            ...
            {filteredRows.map((row) => {
              ...
              return (
                <tr key={row.id} className={hasError ? 'bg-red-50/60' : undefined}>
                  ...
                  <td className="px-3 py-2">{formatPrice(row.minimumWholesalePriceKgs)}</td>
                  <td className="px-3 py-2">
                    <input
                      type="number"
                      min="0"
                  ...
                  <td className="px-3 py-2">{formatPrice(row.recommendedWholesalePriceKgs)}</td>
                  <td className="px-3 py-2 font-medium">
                    {row.effectiveMaximumWholesaleMarkupPercent.toFixed(2)}%
                  </td>
                  <td className="px-3 py-2 font-medium">{formatPrice(row.maximumWholesalePriceKgs)}</td>
                  <td className="px-3 py-2">
                    <span
