...
export type BranchAccountantInvoice = {
  ...
  installmentEarlyPaymentRequests?: Array<{
    ...
    remainingDebtAtRequest?: number;
    expectedRemainingDebtAfterPayment?: number;
    financeAccount?: { id: string; name: string; accountNumber: string; availableBalance: number } | null;
    requestComment?: string | null;
    rejectionComment?: string | null;
    requestedAt: string;
    requestedBy?: { id: string; fullName: string } | null;
    branchCeoApprovedBy?: { id: string; fullName: string } | null;
    branchCeoApprovedAt?: string | null;
    sentToCashierBy?: { id: string; fullName: string } | null;
    sentToCashierAt?: string | null;
    canSendToCashier?: boolean;
    sentToCashier?: boolean;
  }>;
  activeEarlyPaymentRequest?: {
    id: string;
    installmentId?: string | null;
    paymentType: 'PARTIAL' | 'FULL';
    status: string;
