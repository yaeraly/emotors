...
export const NOTIFICATION_ROUTING: Partial<Record<AlertType, NotificationRouting>> = {
  ...
  BRANCH_ORDER_APPROVED: { module: NotificationModule.BRANCH_ORDERS, roles: [Role.MANAGER, Role.FRANCHISE_OWNER, Role.HQ_SALES_MANAGER] },
  ...
  BRANCH_INVOICE_CREATED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT, Role.SUPPLY_CHAIN_MANAGER, Role.FINANCE_MANAGER, Role.CASHIER] },
  BRANCH_PAYMENT_SUBMITTED: { module: NotificationModule.FINANCE, roles: [Role.HQ_ACCOUNTANT, Role.FINANCE_MANAGER] },
  BRANCH_PAYMENT_REJECTED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT, Role.CASHIER] },
  BRANCH_INSTALLMENT_REQUESTED: { module: NotificationModule.FINANCE, roles: [Role.CEO, Role.OWNER, Role.FINANCE_MANAGER] },
  BRANCH_INSTALLMENT_APPROVED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT, Role.MANAGER, Role.CASHIER] },
  BRANCH_INSTALLMENT_REJECTED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT, Role.MANAGER] },
  BRANCH_EARLY_PAYMENT_REQUESTED: { module: NotificationModule.FINANCE, roles: [Role.FRANCHISE_OWNER] },
  BRANCH_EARLY_PAYMENT_APPROVED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT] },
  BRANCH_EARLY_PAYMENT_REJECTED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT] },
  BRANCH_EARLY_PAYMENT_SENT_TO_CASHIER: { module: NotificationModule.FINANCE, roles: [Role.CASHIER] },
  BRANCH_EARLY_PAYMENT_CONFIRMED: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT, Role.FRANCHISE_OWNER] },
  INSTALLMENT_FULLY_PAID: { module: NotificationModule.FINANCE, roles: [Role.ACCOUNTANT, Role.FRANCHISE_OWNER] },
  BRANCH_ORDER_READY_FOR_WAREHOUSE: { module: NotificationModule.WAREHOUSE, roles: [Role.WAREHOUSE_MANAGER] },
