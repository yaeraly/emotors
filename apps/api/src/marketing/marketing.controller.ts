...
export class MarketingController {
  ...
  @Post('assets') createAsset(@CurrentUser() user: AuthUser, @Body() dto: any) { return this.marketingService.createAsset(user, dto); }
  ...
  @Post('campaigns') createCampaign(@CurrentUser() user: AuthUser, @Body() dto: any) { return this.marketingService.createCampaign(user, dto); }
