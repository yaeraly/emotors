...
export class ProcurementController {
  ...
  @Post('orders/:id/items') @Roles(...PROCUREMENT_ROLES) addItems(@CurrentUser() user: AuthUser, @Param('id') id: string, @Body() dto: any) { return this.service.addProcurementOrderItems(user, id, dto); }
