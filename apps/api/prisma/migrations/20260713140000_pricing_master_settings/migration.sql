...
CREATE UNIQUE INDEX IF NOT EXISTS "PricingMasterSettings_singletonKey_key" ON "PricingMasterSettings"("singletonKey");
CREATE INDEX IF NOT EXISTS "PricingMasterSettings_updatedById_idx" ON "PricingMasterSettings"("updatedById");
